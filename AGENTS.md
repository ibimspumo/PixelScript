...
- README art assets live in `docs/readme-assets`
- They are generated by `scripts/generate-readme-assets.mjs`
...
- If `README.md` changes its visual sections, regenerate these assets before committing
